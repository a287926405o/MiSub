...
const OutboundSettingsView = () => import('../views/OutboundSettingsView.vue');
const RoutingRulesView = () => import('../views/RoutingRulesView.vue');
...
const routes = [
    ...
    },
    {
        ...
        name: 'OutboundSettings',
        component: OutboundSettingsView,
        meta: { title: '出站设置' }
    },
    {
